...
/* "snappy" */
#define GRPC_MDSTR_SNAPPY (grpc_static_slice_table()[43])
/* "GET" */
...
/* "identity,snappy" */
#define GRPC_MDSTR_IDENTITY_COMMA_SNAPPY (grpc_static_slice_table()[111])
/* "deflate,snappy" */
#define GRPC_MDSTR_DEFLATE_COMMA_SNAPPY (grpc_static_slice_table()[112])
/* "identity,deflate,snappy" */
#define GRPC_MDSTR_IDENTITY_COMMA_DEFLATE_COMMA_SNAPPY \
  (grpc_static_slice_table()[113])
/* "gzip,snappy" */
#define GRPC_MDSTR_GZIP_COMMA_SNAPPY (grpc_static_slice_table()[114])
/* "identity,gzip,snappy" */
#define GRPC_MDSTR_IDENTITY_COMMA_GZIP_COMMA_SNAPPY \
  (grpc_static_slice_table()[115])
/* "deflate,gzip,snappy" */
#define GRPC_MDSTR_DEFLATE_COMMA_GZIP_COMMA_SNAPPY \
  (grpc_static_slice_table()[116])
/* "identity,deflate,gzip,snappy" */
#define GRPC_MDSTR_IDENTITY_COMMA_DEFLATE_COMMA_GZIP_COMMA_SNAPPY \
