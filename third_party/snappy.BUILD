...
cc_library(
    ...
    hdrs = ["snappy.h"],
    # TODO (mattbrown): add windows back here - https://docs.bazel.build/versions/master/configurable-attributes.html
    # look at tensorflow to check for windows logic
    copts = [
      "-DHAVE_CONFIG_H",
      "-fno-exceptions",
      "-Wno-sign-compare",
